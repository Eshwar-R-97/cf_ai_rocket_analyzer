...
## If you want to try it out yourself, grab the example flight data csvs here (or run a simulation to get your own) and input it into the hosted version of this repo here: 
https://cf-ai-rocket-analyzer.eshwar-rajasekar.workers.dev
